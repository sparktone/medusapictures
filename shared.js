const LABELS = {
  medusa: {
    ...
    color:  '#922B2B',
    bg:     '#F0E6E6',
    desc:   "The original British home-video label, active from the 1980s to the 2000s. Its catalogue spans action, horror, thriller, and international genre releases distributed on VHS across the United Kingdom, as well as theatrical releases ranging from the cult classic <i>Teenage Mutant Ninja Turtles</i> to Rob Reiner's acclaimed adaptation of Stephen King's <i>Misery</i>.<br>They have been mainly known as <b>Medusa Communications Limited</b>, and later as <b>Medusa Communications and Marketing Limited</b>, but often branded as <b>Medusa Pictures</b>. For clarity, we will mainly refer to them as the latter.<br><br>Although reasonable care has been taken in preparing this content, this page might contain inaccuracies or omissions. Please <b><a href=\"contact.html\">Contact Us</a></b> for corrections.<br><strong>Note:</strong> Many online databases begin certain Medusa catalogue numbers with \'MO\', but it has been officially confirmed that these numbers were an \'M\' followed by four numbers beginning with the <i>number</i> \'0\', and not the <i>letter</i> \'O\'.",
    period: '1980s – 2000s',
